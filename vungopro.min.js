...
$.fn.scrollTo = function(a) {
    var b = Math.round,
        ...
        g = c.toT - f,
        h = 0,
        i = b(c.durTime / c.delay),
        j = function(a) {
            h++;
            var j = b(g / i);
            return h >= i ? (e.scrollTop(a), window.clearInterval(d), void(c.callback && "function" == typeof c.callback && c.callback())) : void e.scrollTop(f + h * j)
        };
    return d = window.setInterval(function() {
        j(c.toT)
    }, c.delay), e
};
